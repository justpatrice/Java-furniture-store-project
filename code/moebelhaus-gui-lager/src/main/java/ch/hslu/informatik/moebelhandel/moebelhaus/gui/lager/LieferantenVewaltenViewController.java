...
public class LieferantenVewaltenViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tblLieferanten.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<LieferantenWrapper>() {
            ...
            @Override
            public void changed(ObservableValue<? extends LieferantenWrapper> observable, LieferantenWrapper oldValue,
                    LieferantenWrapper newValue) {
        ...
        if (eingabeValid()) {
            ...
            if (tblLieferanten.getSelectionModel().getSelectedItem() == null) {
                ...
                try {
                    ...
                    alert.setTitle("Lieferanten speichern");
    ...
    private void loeschen() {
        ...
        if (lieferant != null) {
            try {
                ...
                Alert alert = new Alert(AlertType.ERROR);
                alert.setTitle("Lieferanten löschen");
                alert.setHeaderText("Information");
