	...
	public static void main(String[] args) {
		...
		try {
			...
			if (reg != null) {
				...
				// MoebelhausLagerService-RemoteObject erstellen und binden
				RmiMoebelhausLagerService moebelhausLagerServiceRO = new RmiMoebelhausLagerServiceImpl();
				...
				// KasseService-RemoteObject erstellen und binden
