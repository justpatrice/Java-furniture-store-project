...
public class MoebelhausLagerManager implements MoebelhausLagerService {
    ...
    public List<Produkt> produktBestand(ProduktTyp produktTyp) throws Exception {
        try {
            ...
            String msg = "Produktbestand für den ProduktTyp \'" + produktTyp.getName()
    ...
    public List<Produkt> produktBestand(String produktTypCode) throws Exception {
        try {
            ...
            String msg = "Produktbestand für den ProduktTyp-Code \'" + produktTypCode
                    + "\' konnte nicht abgefragt werden";
            logger.error(msg, e);
            throw new Exception(msg);
        }
    ...
    public void produktEinlagern(ProduktTyp produktTyp, int anzahl) throws Exception {
        ...
        for (int i = 0; i < anzahl; i++) {
            ...
            try {
                ...
                dao.save(p);
                logger.info("Produkt eingelagert: [ProduktTyp-Code: " + produktTyp.getTypCode() + ", ProduktCode: "
                        + p.getCode());
            } catch (Exception e) {
